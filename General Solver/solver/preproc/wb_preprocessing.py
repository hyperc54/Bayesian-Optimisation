...
'''
def refineBounds(bounds,func,taille_min,nbLocalSolversINI=500000):
    fini=[]
    to_compute=[bounds]
    undef=[]
    inc=0
...
def preprocFeasibleSpace(list_func,bounds,taille_min_percent,GRAPHE=0,nbLocalSolversInitial=50000):
